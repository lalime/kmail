...
/**
 * @credit to javaTips.com, For the sample they provided.
 * 
 * @author w2b
 *
 */
public class SimpleGmailPOP3WithSSLMailsReader implements MailReader {
	...
	public SimpleGmailPOP3WithSSLMailsReader(String username, String password) {
		super();
